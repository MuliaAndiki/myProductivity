import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@repo/shared';
import { cn } from '@/utils/classname';
import React from 'react';
import { cva, type VariantProps } from 'class-variance-authority';
import { CheckIcon, XCircle, ChevronDown, XIcon, WandSparkles } from 'lucide-react';
import { Separator, Button, Badge, Popover, PopoverContent, PopoverTrigger } from '@repo/shared';
import {
  Command,
  CommandEmpty,
  CommandGroup,
                      ...
                      selectedValues.slice(0, maxCount).map((value) => {
                        ...
                        return (
                          <Badge
                            ...
                            style={{ animationDuration: `${animation}s` } as any}
                          >
